...
class Surat_doa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('konsultan/list_surat_view', $data);
    }
    ...
    public function surat($nomor)
    {
        ...
        // print_r($data);
        // exit();
        $this->load->view('konsultan/surat_view', $data);
    }
    ...
    public function doa()
    {
        ...
        $this->load->view('konsultan/doa_view', $data);
    }

    public function tasbih()
    {
        $this->load->view('konsultan/counter_tasbih_view');
    }
}
