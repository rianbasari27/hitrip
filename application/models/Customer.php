...
class Customer extends CI_Model
{
    ...
    public function sendEmail($email) {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'hai.seidea@gmail.com';
            $mail->Password   = 'vkhqmuasylbxfcyc';
            $mail->SMTPSecure = 'tls';
            $mail->Port       = 587;            
            ...
            $mail->setFrom('hai.seidea@gmail.com', 'Admin Hi-Trip');
            ...
            $mail->Body = "
                            ...
                            <body>
                                <div class='container'>
                                    ...
                                    <p><a class='button' href='$link'>Klik untuk reset Password</a></p>
                                </div>
                            </body>
                            </html>
                            ";
