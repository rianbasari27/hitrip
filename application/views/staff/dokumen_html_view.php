            ...
            <div class="card-body">
                ...
                <div class="row" style="margin-top: 10rem; text-align:center;">
                    ...
                    <h5 class="card-text title" style="margin-top: 0;">No :
                        <?php echo $id_request ?>/S.Rekomendasi/VSW/<?php echo $bulan;?>/<?php echo $tahun; ?>
                    </h5>
                </div>
                <div class="row" style="margin-left:5rem; text-align:justify; margin-right:5rem;">
                ...
                <div class="row" style="margin-right:5rem; text-align:right;">
