                                                ...
                                                <table class="table table-bordered" width="100%" cellspacing="0" id="">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><strong><?php echo $detail->sudah_sebagian; ?></strong> Sudah
                                                                Ambil Sebagian
                                                            </td>
                                                            <td><strong><?php echo $detail->belum_ambil; ?></strong> Belum
                                                                Ambil Semua
                                                            </td>
                                                        </tr>
                                                        <?php endforeach; ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><a href="<?php echo base_url() ?>staff/paket/lihat?id=<?php echo $item->id_paket ?>"><?php echo $item->nama_paket ?></a></td>
                                                            <td><?php echo date_format(date_create($item->tanggal_berangkat), 'd M Y') ?></td>
                                                            <td><?php echo $item->sisa_seat ?> orang</td>
                                                            <td><strong><?php echo $item->total_belum_lunas ?></strong> orang</td>
                                                            <td><strong><?php echo $item->total_lunas ?></strong> orang</td>
                                                            <td><strong><?php echo $item->total_cicil ?></strong> orang</td>
                                                            <td><strong><?php echo $item->total_lebih ?></strong> orang</td>
                                                        </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                                </table>
