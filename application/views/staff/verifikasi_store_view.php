                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Verifikasi Store Order
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4 border-left-primary">
                                    ...
                                    <div class="card-body">
                                        <form role="form"
                                            action="<?php echo base_url(); ?>staff/bayar_store/proses_verifikasi<?php echo $refund != null ? '?refund=1' : '' ?>"
                                            method="post">
                                            <input type="hidden" name="id_pembayaran"
                                                value="<?php echo $dataBayar['data']->id_pembayaran; ?>">
                                            <input type="hidden" name="order_id"
                                                value="<?php echo $dataBayar['data']->id_member; ?>">
                                            <div class="form-group">
                                                <label
