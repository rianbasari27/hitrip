                                        ...
                                        <div class="card-header-elements ml-auto">
                                            <label class="text m-0">
                                                <span
                                                    ...
                                                    STATS</span>
                                                <span
                                                    class="switcher switcher-sm d-inline-block align-middle mr-0 ml-2"><input
                                                        type="checkbox" class="switcher-input" checked><span
                                                        class="switcher-indicator"><span
                                                            class="switcher-yes"></span><span
                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-4 bg-pattern-2 bg-primary text-white">
                                            <div class="card-body">
                                                ...
                                                <div id="order-chart-1" class="mt-3 chart-shadow" style="height:40px">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col">
                                                        <h6 class="mb-0 text-muted">Total <span
                                                                class="text-primary">Subscription</span></h6>
                                                ...
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col">
                                                        <h6 class="mb-0 text-muted"><span
                                                                class="text-primary">Order</span> Status</h6>
                                    ...
                                    <div class="card-header with-elements pb-0">
                                        ...
                                        <div class="card-header-elements ml-auto p-0">
                                            <ul class="nav nav-tabs">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#sale-stats">Sale
                                                        stats</a>
                                                </li>
                                                <li class="nav-item">
                                                    ...
                                                    <table class="table table-hover card-table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="media mb-0">
                                                                        <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/3-small.png"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="media mb-0">
                                                                        <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/1-small.png"
                                                                            class="d-block ui-w-40 rounded-circle"
                                                                            alt="">
                                                                        <div class="media-body align-self-center ml-3">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="align-middle">
                                                                    <a href="javascript:" class="text-dark">PlayStation
                                                                        4 1TB (Jet Black)</a>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="align-middle">
                                                                    <a href="javascript:" class="text-dark">Apple iWatch
                                                                        (black)</a>
                                                                </td>
                                                                <td class="align-middle">1</td>
                                                            ...
                                                            <tr>
                                                                <td class="align-middle">
                                                                    <a href="javascript:" class="text-dark">WALKING 400
                                                                        BLUE CAT3</a>
                                                                </td>
                                                                <td class="align-middle">2</td>
