                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Output Barang Baru</h1>
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4 border-left-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php } ?>
                                        <form role="form"
                                            action="<?php echo base_url(); ?>staff/barang/proses_out_barang"
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label">Jumlah Barang Keluar</label>
                                                <input class="form-control" type="number" name="barang_keluar">
                                            </div>
                                            <div class="form-group">
