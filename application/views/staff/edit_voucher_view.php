                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Edit Voucher Paket</h1>
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4 border-left-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php } ?>
                                        <form role="form" action="<?php echo base_url(); ?>staff/voucher/proses_edit"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input class=" checks" type="checkbox"
                                                                        ...
                                                                        <?php echo in_array($p->id_paket, $voucher->paket) ? 'checked' : '' ?>>
                                                                </td>
