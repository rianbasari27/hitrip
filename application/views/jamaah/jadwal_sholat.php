...
<body class="theme-light">
    ...
    function displayPrayerTimes(pray, timezone, city, country, date) {
        ...
        function displayTime() {
            ...
            const timeOptions = { timeZone: timezone, hour12: false, hour: 'numeric', minute: 'numeric' };
        ...
        $.each(pray, function(key, value) {
            ...
            html += '<div class="col-6 mb-3"><p class="font-16 color-theme text-end font-700">' + value + '</p></div>';
        });
        html += '</div>';
        html += '</div>';
