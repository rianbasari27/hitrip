...
<body class="theme-light">
    ...
    <div id="page">
        ...
        <!-- header-bar -->
        <?php $this->load->view('jamaah/include/header_bar', ['always_show' => true]); ?>
        ...
        <div class="card card-fixed" style="background-image:url(<?php echo base_url() ?>asset/images/city/dubai-1280x720.jpg)" data-card-height="350"></div>
        ...
        <div class="page-content mt-n1">
            ...
            <div class="card card-full mb-n5 rounded-l pb-4">
                ...
                <div class="content p-3 mt-3">
                    <h2>Liburan akhir tahun hemat hingga 2 juta rupiah!</h2>
                    <div class="divider mt-3 mb-3"></div>
                    <p>Bersiaplah untuk mengisi liburan akhir tahun Anda dengan keajaiban! Dapatkan pengalaman liburan yang tak terlupakan dengan promo spesial kami! Jelajahi destinasi menakjubkan, nikmati akomodasi berkualitas, cicipi kuliner lokal yang lezat, semuanya dengan harga yang terjangkau. Dan jangan lewatkan potongan harga hingga 2 juta rupiah! Segera pesan sekarang dan dapatkan bonus eksklusif untuk pemesanan awal! Jadikan setiap momen liburan akhir tahun Anda tak terlupakan bersama kami.</p>
                    <h4>Expired : 10 Jan 2025</h4>
                    <a href="#" class="btn btn-full btn-m mt-5 rounded-s text-uppercase font-700 shadow-s gradient-highlight">Dapatkan promo</a>
