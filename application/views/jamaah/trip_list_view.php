            ...
            <div class="content">
                ...
                <div class="mt-0 mb-4">
                    <div class="search-box search-dark bg-theme rounded-sm bottom-0">
                        ...
                        <input type="text" class="border-0" placeholder="Searching for something? Try 'dubai'"
                            data-search>
                    </div>
                        ...
                        <div>
                            ...
                            <a href="#" class="card card-style my-3" aria-label="<?php echo $pkt->nama_paket ?>"
                                ...
                                <div class="d-flex content">
                                    ...
                                    <div class="align-self-center">
                                        <h2 class="font-16 font-700 mb-1 line-height-s mt-1">
                                            <?php echo $pkt->nama_paket ?></h2>
