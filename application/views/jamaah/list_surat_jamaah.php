...
<body class="theme-light">
    ...
    <div id="page">
        ...
        placeholder="Search by title" value=""> -->
            ...
            <a href="<?php echo base_url() . 'jamaah/surat_doa/surat/' . $s['nomor']?>" class="card card-style mb-3"
                id="no<?php echo $s['nomor'] ?>">
        ...
        token.then((result) => {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // console.log(index);
                    $('#bookmark' + parsedData.bookmark.no_surat).html(
                        '<i class="fa-solid fa-book-bookmark me-1"></i>Terakhir dibaca');
                    $('#no' + parsedData.bookmark.no_surat).addClass(
