                        ...
                        <?php if (isset($parent_id)) : ?>
                            <div class="form-group">
                                <div class="input-style has-borders no-icon input-style-always-active validate-field mt-4 mb-4">
                                    <input name="referensi" type="tel" class="form-control validate-name upper" id="form9" value="<?php echo $jamaah->referensi ?>" readonly>
                                ...
                                <?php if ($jamaah->referensi != 'Agen') : ?>
                                    <div class="input-style has-borders no-icon input-style-always-active validate-field mt-4 mb-4">
                                        <input name="office" type="tel" class="form-control validate-name upper" id="form10" value="<?php echo $jamaah->office ?>" readonly>
                                ...
                                <?php else : ?>
                                    <div class="input-style has-borders no-icon input-style-always-active validate-field mt-4 mb-4">
                                        <input type="hidden" name="id_agen" value="<?php echo $jamaah->member[0]->agen->id_agen ?>">
                                        <input name="agen" type="tel" class="form-control validate-name upper" id="form11" value="<?php echo $jamaah->member[0]->agen->nama_agen ?>" readonly>
