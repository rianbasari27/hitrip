...
<head>
    ...
    <style>
        .bg-6 {
            background-image: url("<?php echo base_url(); ?>asset/appkit/images/voucher-banner.jpg");
        }
    </style>
</head>
        ...
        <div class="page-content">
            <div class="card card-style">
                <div class="content mt-3">
                    <div class="card card-style mx-0 bg-6" data-card-height="150"></div>
            ...
            <div class="card card-style">
                <div class="content mt-0 mb-0"> -->
                    ...
                    <form role="form" action="<?php echo base_url(); ?>jamaah/voucher/proses" method="post" enctype="multipart/form-data" id="myForm">
                        ...
                        <a href="#" id="submitBtn" data-back-button class="btn btn-s btn-full font-600 font-13 gradient-highlight rounded-s mb-3">Klaim</a>
                    </form>
                </div>
            </div>
