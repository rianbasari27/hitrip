<!-- <div id="notification" data-dismiss="notification" data-bs-delay="3000" data-bs-autohide="true" data-isalert="<?php echo isset($_SESSION['alert']) ? 'true' : 'false'; ?>" class="notification bg-<?php echo isset($_SESSION['alert']) ? $_SESSION['alert']['color'] : ''; ?>-dark shadow-xl opacity-95"> -->
    <div id="notification" data-dismiss="notification" data-bs-delay="3000" data-bs-autohide="true" data-isalert="<?php echo isset($_SESSION['alert']) ? 'true' : 'false'; ?>" class="notification alert me-3 ms-3 rounded-s bg-<?php echo isset($_SESSION['alert']) ? $_SESSION['alert']['color'] : ''; ?>-dark" role="alert" data-isalert="<?php echo isset($_SESSION['alert']) ? 'true' : 'false'; ?>">
