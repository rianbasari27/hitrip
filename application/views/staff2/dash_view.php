...
<head>
    <?php $this->load->view('staff2/include/header_view'); ?>
</head>
...
<body>
    ...
    <div class="layout-wrapper layout-2">
        <div class="layout-inner">
            <?php $this->load->view('staff2/include/side_menu') ?>
            <!-- [ Layout container ] Start -->
            <div class="layout-container">
                <!-- [ Layout navbar ( Header ) ] Start -->
                <nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-white container-p-x" id="layout-navbar">

                    <!-- Brand demo (see <?php echo base_url() ?>asset/bhumlu/css/demo/demo.css) -->
                    <a href="index.html" class="navbar-brand app-brand demo d-lg-none py-0 mr-4">
                        <span class="app-brand-logo demo">
                            <img src="<?php echo base_url() ?>asset/bhumlu/img/logo-dark.png" alt="Brand Logo" class="img-fluid">
                        </span>
                        <span class="app-brand-text demo font-weight-normal ml-2">Bhumlu</span>
                    </a>

                    <!-- Sidenav toggle (see <?php echo base_url() ?>asset/bhumlu/css/demo/demo.css) -->
                        ...
                        <div class="navbar-nav align-items-lg-center ml-auto">
                            ...
                            <div class="demo-navbar-messages nav-item dropdown mr-lg-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="list-group list-group-flush">
                                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                                            <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/6-small.png" class="d-block ui-w-40 rounded-circle" alt>
                                        ...
                                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                                            <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/4-small.png" class="d-block ui-w-40 rounded-circle" alt>
                                            <div class="media-body ml-3">
                                        ...
                                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                                            <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/5-small.png" class="d-block ui-w-40 rounded-circle" alt>
                                            <div class="media-body ml-3">
                                        ...
                                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                                            <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/11-small.png" class="d-block ui-w-40 rounded-circle" alt>
                                            <div class="media-body ml-3">
                            ...
                            <div class="demo-navbar-user nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                                    <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                        <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/1.png" alt class="d-block ui-w-30 rounded-circle">
                                                    ...
                                                    <table class="table table-hover card-table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="media mb-0">
                                                                        <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/3-small.png" class="d-block ui-w-40 rounded-circle" alt="">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="media mb-0">
                                                                        <img src="<?php echo base_url() ?>asset/bhumlu/img/avatars/1-small.png" class="d-block ui-w-40 rounded-circle" alt="">
                                                                        <div class="media-body align-self-center ml-3">
    ...
    <!-- [ Layout wrapper] End -->
    <?php $this->load->view('staff2/include/script_view') ?>
</body>
