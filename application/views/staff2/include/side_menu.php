...
<div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-dark">
    <div class="app-brand demo">
        <span class="app-brand-logo demo">
            <img src="<?php echo base_url() ?>asset/appkit/images/hitrip/hitrip-logogram-white.png" alt="Brand Logo" class="img-fluid" width="50px">
        </span>
        <a href="<?php echo base_url() ?>staff/dashboard" class="app-brand-text demo ml-2 mt-3"><img src="<?php echo base_url() ?>asset/appkit/images/hitrip/hitrip-logotype-white.png" width="80px"></a>
