        ...
        <div class="page-content">
            ...
            <div class="card card-style" style="position:relative; height:fit-content;">
                <div class="content mt-0 mb-0">
                    <a href="<?php echo base_url(); ?>jamaah/req_cuti/buat_surat?idm=<?php echo $idSecretMember; ?>">
                            ...
                            <div id="sudahAmbil<?php echo $ctr;?>" class="collapse " data-bs-parent="#accordion-2">
                                <div class="row mt-4 mb-1" style="justify-content: center;">
                                    <div class="col-8 pe-1">
                                        <a href="<?php echo base_url() . "dokum_dl/download_surat_cuti?id=" . $sudahAmbil['dateGroup'][$tglAmbil][0]->idSecretCuti. "&idm=" . $idSecretMember; ?>"
                                ...
                                <div class="row" style="justify-content: center;">
                                    <div class="col-8 pe-1">
                                        <a href="<?php echo base_url() . "jamaah/req_cuti/hapus?id=" . $sudahAmbil['dateGroup'][$tglAmbil][0]->idSecretCuti;?>"
