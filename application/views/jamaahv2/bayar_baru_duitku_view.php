        ...
        <div class="page-content">
            <div class="card card-style">
                <div class="content mt-3">
                    ...
                    <h1><?php echo 'Rp. ' . number_format($tarif['dp_display'], 0, ',', '.') . ',-'; ?></h1>
                    <?php else : ?>
                    ...
                    <form action="<?php echo base_url(); ?>jamaah/pembayaran/proses_bayar_duitku" method="post"
                        id="myForm">
            ...
            <?php $this->load->view('jamaahv2/cara_pembayaran_duitku', ['nomorVAOpen' => $tarif['nomorVAOpen'], 'nomorVAOpenLuarBSI' => $tarif['nomorVAOpenLuarBSI']]); ?>
