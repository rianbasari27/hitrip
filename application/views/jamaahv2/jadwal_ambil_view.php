        ...
        <div class="page-content">
            <div class="card card-style">
                ...
                <div class="content mt-3">
                    ...
                    <p class="mb-3">
                        ...
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Tanggal :
                            <?php echo $tanggalAmbil;?></span><br>
                        <?php if ($jenisAmbil == 'Pengiriman') { ?>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Jenis :
                            <?php echo $jenisAmbil;?></span><br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">No Telepon :
                            <?php echo $noKirim;?></span><br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Alamat Kirim
                            :<?php echo $alamatKirim;?></span>
                        <?php } else { ?>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Jenis :
                            <?php echo $jenisAmbil;?></span><br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">No Telepon : - </span><br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Alamat Pengambilan : Jln. KH.M
                            Yusuf Raya No.18A-B Mekar Jaya, Depok, Jawa Barat</span>
                        <?php } ?>
                        <?php } ?>
                        <?php if ($tanggalSiap) { ?>
                        Anda telah merencanakan pengambilan perlengkapan untuk Jamaah Anda pada <br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Tanggal :
                            <?php echo $tanggalSiap;?></span><br>
                        <?php if ($jenisAmbilSiap == 'Pengiriman') { ?>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Jenis :
                            <?php echo $jenisAmbilSiap;?></span><br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">No Telepon :
                            <?php echo $noKirimSiap;?></span><br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Alamat Kirim
                            :<?php echo $alamatKirimSiap;?></span>
                        <?php } else { ?>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">Jenis :
                            <?php echo $jenisAmbilSiap;?></span><br>
                        <span class="fw-bold color-highlight" style="font-size: 17px;">No Telepon : - </span><br>
            ...
            <div class="card card-style">
                <div class="content">
                    ...
                    <img src="<?php echo base_url(); ?>asset/appkit/images/perlengkapan2.png"
                        class="img-fluid rounded-sm mb-3"
                        style="width:auto;height:300px;display: block;margin-left: auto;margin-right: auto;">
            ...
            <div class="card card-style">
                <div class="content">
                    ...
                    <form action="<?php echo base_url(); ?>jamaah/perlengkapan/proses_jadwal" method="post">
                        ...
                        <div class="form-group" style="display: none;" id="selectNomor">
                            <label class="color-highlight">No Telepon ( <span class="text-primary">Nomor Telepon
                                    Aktif</span> )</label>
                            <div class="input-style has-borders no-icon mb-4">
                                <input name="no_pengiriman" type="text" class="form-control validate-text">
                                <i class="fa fa-check disabled valid me-4 pe-3 font-12 color-green-dark"></i>
                                <i class="fa fa-check disabled invalid me-4 pe-3 font-12 color-red-dark"></i>
                            </div>
                        </div>
                        ...
                        *</strong>
                        <div class="input-style has-borders no-icon mb-4">
                            <input name="date" type="date" min="<?php echo date('Y-m-d', strtotime('+1 days'));?>"
                        ...
                        <button href="#"
                            class="btn btn-s mb-3 rounded-s text-uppercase font-700 shadow-s bg-green-light">Submit</button>
                    </form>
                    </p>
                </div>
            </div>
