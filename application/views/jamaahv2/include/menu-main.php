...
<div class="card rounded-0 bg-menu" data-card-height="150" style="background-image: url(<?php echo base_url(); ?>asset/appkit/images/side_banner.jpg);">
    ...
    <div class="card-bottom">
        ...
        <?php if (isset($_SESSION['ktp_no'])) {
            $namaJamaah = implode(" ", array_filter([$_SESSION['first_name'], $_SESSION['second_name'], $_SESSION['last_name']]));
        } else {
            $namaJamaah = "Jamaah";
        } ?>
        <p class="mb-2 ps-3 font-14 color-white opacity-50">Welcome <span class="color-highlight font-700"><?php echo $namaJamaah; ?></span></p>
    </div>
...
<?php if (!isset($_SESSION['ktp_no'])) { ?>
    <div class="list-group list-custom-small list-menu">
        ...
        <a href="<?php echo base_url() . 'jamaah/masuk'; ?>" class="btn btn-sm rounded-s gradient-green me-4 color-white" id="nav-welcome" style="color :#FFF !important">
            Masuk
        </a>
    </div>
<?php } ?>
...
<?php if (isset($_SESSION['ktp_no'])) { ?>
    ...
    <div class="list-group list-custom-small list-menu">
        <a href="<?php echo base_url() . 'jamaah/paket'; ?>" id="nav-paket">
            <i class="fa fa-layer-group gradient-orange color-white"></i>
            <span>Paket</span>
            <i class="fa fa-angle-right"></i>
        </a>
        <a href="<?php echo base_url(); ?>jamaah/req_dokumen" id="nav-request">
            <i class="fa fa-file gradient-pink color-white"></i>
            <span>Rekomendasi Imigrasi</span>
            <i class="fa fa-angle-right"></i>
        </a>
        <a href="<?php echo base_url(); ?>jamaah/req_cuti" id="nav-cuti">
            <i class="fa fa-file-pen gradient-magenta color-white"></i>
            <span>Buat Surat Cuti</span>
            <i class="fa fa-angle-right"></i>
        </a>
    </div>
<?php } ?>
...
<?php if (isset($_SESSION['ktp_no'])) { ?>
    <div class="list-group list-custom-small list-menu">
        <a href="<?php echo base_url() . 'jamaah/logout'; ?>" class="btn btn-sm rounded-s gradient-red me-4 mt-3 mb-3 color-white" id="nav-welcome" style="color: #FFF !important">
            Keluar
        </a>
    </div>
<?php } ?>
