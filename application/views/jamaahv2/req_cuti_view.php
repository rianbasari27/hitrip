        ...
        <div class="page-content">
            <div class="card card-style">
                ...
                <div class="content mt-3">
                    ...
                    <h1>Buat Surat Cuti</h1>
                    <p class="mb-0">
                        <?php if (!empty($child)) {
                            echo 'Buat Surat Cuti untuk Anda dan Kerabat Anda' ;
                        } else {
                            echo 'Buat Surat Cuti untuk Anda' ;
                        } ?>
                    </p>
                </div>
            </div>
                    ...
                    <div class="list-group list-custom-large">
                        ...
                        <?php 
                            ...
                            foreach ($child as $c) { 
                                ...
                                ?>
                        <a
                            href="<?php echo base_url(); ?>jamaah/req_cuti/list_surat_cuti?idm=<?php echo $c->jamaahData->member[0]->idSecretMember; ?>">
                            <?php if ($no == 1) { ?>
                        ...
                        if (empty($child)) { ?>
                        <a
                            href="<?php echo base_url(); ?>jamaah/req_cuti/list_surat_cuti?idm=<?php echo $member[0]->idSecretMember; ?>">
