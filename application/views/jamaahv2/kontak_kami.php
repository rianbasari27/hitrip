...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome-animation/0.0.8/font-awesome-animation.min.css"
        rel="stylesheet">
    </link>
    <style>
    .bg-home {
    ...
    <div id="page">
        ...
        <div class="card card-fixed mb-n5" data-card-height="350">
            <div class="map-full">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3965.074246127161!2d106.840366!3d-6.384419!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ebf482b94f85%3A0x295f753f095919f4!2sVentour%20Travel%20Umrah%20%7C%20Wisata%20Muslim%20Turki%2C%20Aqsa%2C%20Dubai%20%7C%20Haji%20Furoda!5e0!3m2!1sen!2sus!4v1701941850533!5m2!1sen!2sus"
        ...
        <div class="content">
            <!-- <a href="https://wa.me/6281295155670"
                class="external-link btn btn-l font-14 shadow-l btn-full rounded-s font-600 bg-green-dark text-start mb-2"><span
                    class="ms-n2">Customer Care</span></a> -->
            ...
            <!-- <a href="tel:+2 234 567 890"
                class="external-link btn btn-l font-14 shadow-l btn-full rounded-s font-600 bg-blue-dark text-start mb-2"><span
                    class="ms-n2">Suppport Center:</span><span class="float-end me-n1">+2 234 567 890</span></a>
            <a href="tel:+3 234 567 890"
                class="external-link btn btn-l font-14 shadow-l btn-full rounded-s font-600 bg-red-dark text-start"><span
                    class="ms-n2">Emergency 24/7:</span><span class="float-end me-n1">+3 234 567 890</span></a>
            <p class="color-theme text-center font-10 opacity-30 pt-2 mt-2 mb-0 pb-0">Emergency Available 24/7 - Regular
                Numbers Mon-Fri 09:00 - 05:00 </p> -->
        </div>
    </div>
