        ...
        <div class="page-content">
            ...
            <div class="card card-style">
                <div class="content mt-3">
                    ...
                    <h1><?php echo $sisaTagihan != 0 ? 'Rp. ' . number_format($sisaTagihan+$tarif['vaOpenAdminFee'], 0, ',', '.') . ',-' : 'Rp. ' . number_format($sisaTagihan, 0, ',', '.') . ',-' ;?>
                    </h1>
            ...
            <?php $this->load->view('jamaahv2/cara_pembayaran_view', ['nomorVAOpen' => $tarif['nomorVAOpen'], 'nomorVAOpenLuarBSI' => $tarif['nomorVAOpenLuarBSI']]); ?>
