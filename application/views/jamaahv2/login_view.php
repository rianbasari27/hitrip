                ...
                <form action="<?php echo base_url() . 'jamaah/login/proses' ;?>" id="myForm" method="post">
                    <div class="content px-4">
                        <div class="input-style input-transparent no-borders has-icon validate-field mb-4">
                            ...
                            <input type="name" name="username" class="form-control validate-name" id="form1a" placeholder="Username">
                        ...
                        <a href="#" id="submitBtn" data-back-button class="btn btn-full btn-l font-600 font-13 gradient-highlight mt-4 rounded-s">Sign In</a>
                        ...
                        <div class="row pt-3 mb-3">
                            ...
                            <div class="col-6 text-end font-11">
                                <a class="color-white opacity-50" href="<?php echo base_url() . 'jamaah/login/sign_up' ;?>">Create Account</a>
                            </div>
                        </div>
                    </div>
                </form>
