    ...
    <div id="page">
        ...
        <div class="page-content">
            ...
            <div class="card card-style">
                <div class="content my-2">
                    ...
                    <div class="row mb-0">
                        <div class="d-flex">
                            <div class="col-3 mb-4 pe-0"><img
                                    src="<?php echo ($currentPaket->banner_image) ? base_url() . $currentPaket->banner_image : base_url() . 'asset/appkit/images/pictures/default/default_150x150.png'; ?>"
                                    class="rounded-sm shadow-xl img-fluid">
                            </div>
        ...
        <div id="menu-bulan" class="menu menu-box-bottom rounded-m" data-menu-height="450" data-menu-effect="menu-over">
            ...
            <div class="me-4 ms-3 mt-2">
                <div class="list-group list-custom-small">
                    <a href="<?php echo base_url() . 'jamaah/daftar#'; ?>"><span>Semua
                            Keberangkatan</span><i class="fa fa-angle-right"></i></a>
                    <?php foreach ($availableMonths as $month) { ?>
                    <a
                        href="<?php echo base_url() . 'jamaah/daftar?month=' . substr($month->tanggal_berangkat, 5, 2); ?>#paket"><span><?php echo $this->date->convert('F', $month->tanggal_berangkat); ?></span><i
