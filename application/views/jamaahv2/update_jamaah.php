        ...
        <div class="page-content">
            ...
            <div class="card card-style">
                <div class="content mt-0 mb-0">
                    <form role="form" action="<?php echo base_url(); ?>jamaah/dokumen/proses_update_data" method="post" enctype="multipart/form-data" id="myForm">
                        <input type="hidden" name="id_member" value="<?php echo $member->id_member; ?>">
                        <input type="hidden" name="id_jamaah" value="<?php echo $member->id_jamaah; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-style no-borders has-icon  mb-4">
                                <input type="text" name="first_name" class="form-control capital" value="<?php echo $jamaah->first_name; ?>">
                                <em></em>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="color-highlight">Jenis Kelamin </label><strong class="text-danger"> *</strong>
                            <div class="input-style no-borders has-icon mb-4">
                                <select name="jenis_kelamin" class="form-control">
                                    <option value="L" <?php echo $jamaah->jenis_kelamin == 'L' ? 'selected' : ''; ?>>
                                        LAKI-LAKI
                                    </option>
                                    <option value="P" <?php echo $jamaah->jenis_kelamin == 'P' ? 'selected' : ''; ?>>
                                        PEREMPUAN
                                    </option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-style no-borders has-icon  mb-4">
                                <select name="status_perkawinan" class="form-control">
                                    <option value="Belum Kawin" <?php echo $jamaah->status_perkawinan == 'Belum Kawin' ? 'selected' : ''; ?>>
                                        BELUM
                                        KAWIN
                                    </option>
                                    <option value="Kawin" <?php echo $jamaah->status_perkawinan == 'Kawin' ? 'selected' : ''; ?>>
                                        KAWIN
                                    </option>
                                    <option value="Cerai" <?php echo $jamaah->status_perkawinan == 'Cerai' ? 'selected' : ''; ?>>
                                        CERAI
                                    </option>
                                </select>
                        ...
                        <div class="form-group">
                            <label class="color-highlight">Nomor HP (<span class="text-primary font-italic font-weight-lighter"> Aktif WhatsApp
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-style no-borders has-icon  mb-4">
                                <input type="text" name="email" class="form-control" value="<?php echo $jamaah->email; ?>">
                                <em></em>
                            </div>
                        </div>
                        <div class="form-group">
                                        ...
                                        <?php } else { ?>
                                            <center>
                                                <div id="upload_penyakit">
                                                    <?php $format = substr($jamaah->upload_penyakit, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $jamaah->upload_penyakit; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $jamaah->upload_penyakit; ?>" title="Surat Dokter" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $jamaah->upload_penyakit; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <center>
                                                <div id="paspor_scan">
                                                    <?php $format = substr($member->paspor_scan, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $member->paspor_scan; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $member->paspor_scan; ?>" title="Scan Paspor" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $member->paspor_scan; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
                                    ...
                                    <div class="col-lg-6">
                                        <input class="form-control files-form files-form" type="file" name="paspor_scan">
                                    </div>
                                </div>
                                <em></em>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <center>
                                                <div id="paspor_scan2">
                                                    <?php $format = substr($member->paspor_scan2, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $member->paspor_scan2; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $member->paspor_scan2; ?>" title="Scan Paspor 2" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $member->paspor_scan2; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <center>
                                                <div id="ktp_scan">
                                                    <?php $format = substr($member->ktp_scan, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $member->ktp_scan; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $member->ktp_scan; ?>" title="Scan KTP" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $member->ktp_scan; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <center>
                                                <div id="foto_scan">
                                                    <?php $format = substr($member->foto_scan, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $member->foto_scan; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $member->foto_scan; ?>" title="Scan Foto" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $member->foto_scan; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <center>
                                                <div id="kk_scan">
                                                    <?php $format = substr($member->kk_scan, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $member->kk_scan; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $member->kk_scan; ?>" title="Scan KK" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $member->kk_scan; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <center>
                                                <div id="visa_scan">
                                                    <?php $format = substr($member->visa_scan, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $member->visa_scan; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $member->visa_scan; ?>" title="Scan Visa" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $member->visa_scan; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
                        ...
                        <label class="color-highlight">Scan Vaksin (<span class="text-primary font-italic font-weight-lighter"> Jika tidak ada bisa
                                hubungi admin atau konsultan </span> )</label>
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <center>
                                                <div id="vaksin_scan">
                                                    <?php $format = substr($member->vaksin_scan, -3);
                                                    if ($format == 'pdf') { ?>
                                                        <a href="<?php echo base_url() . $member->vaksin_scan; ?>" class="btn btn-sm rounded-xs btn-success btn-icon-split my-2">
                                                            <span class="icon text-white-50">
                                                                <i class="fas fa-file-pdf"></i>
                                                            </span> <span class="text">Download</span></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo base_url() . $member->vaksin_scan; ?>" title="Scan Vaksin" class="default-link " data-gallery="gallery-1">
                                                            <img src="<?php echo base_url() . $member->vaksin_scan; ?>" class="img-fluid shadow-xl rounded-sm" style="width:auto; height:150px">
                                                        </a>
                                                    <?php } ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#provinsi").change(function() {
                ...
                $.getJSON("<?php echo base_url() . 'jamaah/dokumen/getRegencies'; ?>", {
                    provId: provId
                }, function(data) {
            ...
            $(".hapusImg").click(function() {
                ...
                $.getJSON("<?php echo base_url() . 'jamaah/dokumen/hapus_upload'; ?>", {
                        id_member: "<?php echo $member->idSecretMember; ?>",
                        field: id
                    })
                    .done(function(json) {
            ...
            $(".hapusDokter").click(function() {
                var id = $(this).attr('rel');
                $.getJSON("<?php echo base_url() . 'jamaah/dokumen/hapus_surat_dokter'; ?>", {
