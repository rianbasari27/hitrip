        ...
        <div class="page-content">
            ...
            <div class="card card-style">
                <div class="content mt-0 mb-0">
                    <form role="form" action="<?php echo base_url(); ?>jamaah/req_cuti/proses_tambah_cuti" method="post"
                        ...
                        <div class="form-group mb-3 mt-2">
                            <label class="color-highlight">Jabatan <strong class="text-danger"> *</strong></label>
                            <div class="input-style no-borders has-icon  mb-4">
                        ...
                        <div class="form-group mb-3 mt-2">
                            <label class="color-highlight">Keterangan <strong class="text-danger"> *</strong></label>
                            <div class="input-style no-borders has-icon  mb-4">
                        ...
                        <div class="form-group mb-3 mt-2">
                            <label class="color-highlight">Jenis Nomor Induk <strong class="text-danger">
                                    *</strong></label>
                            <div class="input-style no-borders has-icon  mb-4">
                                ...
                                <input type="text" id="lainnya" name="lainnya" style="display: none;"
                                    placeholder="Masukkan Jenis Nomor Induk">
                                <i class="fa fa-times disabled invalid color-red-dark"></i>
                                <i class="fa fa-check disabled valid color-green-dark"></i>
                            </div>
                        </div>
                        <div class="form-group mb-3 mt-2">
                            <label class="color-highlight">Nomor Induk <strong class="text-danger"> *</strong></label>
                            <div class="input-style no-borders has-icon  mb-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-style no-borders has-icon">
                                ...
                                <!-- <a href="#" data-menu="datepicker_mulai" class="text-dark">
                                </a> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-style no-borders has-icon">
                                <textarea name="header_surat" id="header_surat" cols="30" rows="10"
                                    onkeypress="breakLine();"></textarea>
                                <i class="fa fa-check valid color-green-dark"></i>
                                <em></em>
                            </div>
                        </div>
                        <button type="submit"
                            class="btn btn-sm font-600 font-13 gradient-highlight rounded-s mb-3">Submit</button>
