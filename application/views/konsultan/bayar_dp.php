				...
				<div class="content mb-0 pb-5">
					...
					<p class="mb-0">
						...
						dengan keberangkatan tanggal <span
							class="color-highlight font-800"><?php echo $this->date->convert("j F Y", $dataMember[$idMember]['detailJamaah']->member[0]->paket_info->tanggal_berangkat); ?></span>
					...
					<a href="<?php echo base_url() ?>konsultan/jamaah_info/pindah_paket?id=<?php echo $dataMember[$idMember]['id_member'] ?>" class="btn btn-xxs mb-3 rounded text-uppercase font-700 shadow-s gradient-highlight">Pindah Paket</a>
					...
					<h5 class="font-500 opacity-75 color-highlight mb-3">*
						...
						biaya admin.</h5>
					<p>
						Lakukan Pembayaran untuk mengamankan seat Anda. <span class="color-red-dark font-700">* Data dan
					...
					<p class="mt-n4"><span class="color-red-dark font-700" id="ikbal"></span></p>
