        ...
        <div class="page-content">
            <div class="card card-style">
                ...
                <div class="content mt-3">
                    ...
                    <h1>Surat Cuti</h1>
                    <p class="mb-0">
                        Buat surat cuti untuk<br> <span class="color-highlight font-600"
            ...
            <div class="card card-style" style="position:relative; height:fit-content;">
                <div class="content mt-0 mb-0">
                    <a href="<?php echo base_url(); ?>konsultan/req_cuti_konsultan/buat_surat?idm=<?php echo $id_member; ?>">
                        <button class="btn btn-sm bg-highlight mt-4 rounded-s mb-3 ms-3"><i
                                class="fa fa-user-plus fa-xl color-white me-3"></i> Buat Surat Cuti</button>
                    </a>
                    <?php if (empty($sudahAmbil['items'][0])) { ?>
                    <div class="mb-2 ms-3">
                        <strong>Silahkan buat Surat Cuti terlebih dahulu</strong>
                    </div>
                    <?php } ?>
                    <?php if (!empty($sudahAmbil['items'][0])) { ?>
                    <div class="content mb-4" style="border: blue;">
                        <h4 class="font-700 color-dark"><strong>Daftar Surat Cuti Anda</strong></h4>
                    </div>
                    <?php $ctr = 0; ?>
                    ...
                    <div class="card card-style bg-highlight gradient-fade-bottom"
                        ...
                        <div class="accordion mt-1 mb-1" id="accordion-2">
                            <button class="btn accordion-btn no-effect" data-bs-toggle="collapse"
                                ...
                                Tanggal Surat dibuat : <span class="text-success"> <?php echo $tglAmbil; ?></span> <span
                            ...
                            <div id="sudahAmbil<?php echo $ctr;?>" class="collapse " data-bs-parent="#accordion-2">
                                <div class="row mt-4 mb-1" style="justify-content: center;">
                                    <div class="col-8 pe-1">
                                        <a href="<?php echo base_url() . "dokum_dl/download_cuti_agen?idr=" . $sudahAmbil['dateGroup'][$tglAmbil][0]->idSecretCuti . "&idm=" . $id_member; ?>"
                                            class="btn btn-s btn-full mb-3 rounded-xs text-uppercase font-500 shadow-s bg-highlight">Download
                                            Surat Cuti</a>
                                    </div>
                                </div>
                                <div class="row" style="justify-content: center;">
                                    <div class="col-8 pe-1">
                                        <a href="<?php echo base_url() . "konsultan/req_cuti_konsultan/hapus?idr=" . $sudahAmbil['dateGroup'][$tglAmbil][0]->idSecretCuti . "&idm=" . $id_member; ; ?>"
