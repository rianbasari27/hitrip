            ...
            <div class="card card-style">
                <div class="content mt-0 mb-0">
                    ...
                    <h5 class="pt-3 ps-3 color-<?php echo $status == 0 ? 'red' : 'green' ?>-dark">
                        ...
                        <?php echo $msg; ?></h5>
                    <?php } ?>
                    <form role="form" action="<?php echo base_url(); ?>jamaah/voucher/proses" method="post"
                        enctype="multipart/form-data" id="myForm">
                        <div class="input-style no-borders has-icon validate-field my-4">
                            <input type="text" name="kode_voucher" class="form-control" id="form1a"
                        ...
                        <a href="#" id="submitBtn" data-back-button
                            class="btn btn-l font-600 font-13 gradient-highlight rounded-s mb-3">Klaim Voucher</a>
                    </form>
                </div>
            </div>
