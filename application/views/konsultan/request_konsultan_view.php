        ...
        <div class="page-content">
            ...
            <div class="card card-style" style="position:relative; height:fit-content;">
                <div class="content mt-0 mb-0">
                    <a
                        href="<?php echo base_url(); ?>konsultan/request_dokumen_konsultan/input?idm=<?php echo $id_secret; ?>">
                    ...
                    <div class="card card-style bg-highlight gradient-fade-bottom"
                        ...
                        <div class="accordion mt-1 mb-1" id="accordion-2">
                            <button class="btn accordion-btn no-effect" data-bs-toggle="collapse"
                                data-bs-target="#listAmbil<?php echo $ctr;?>" style="color: black;">
                            ...
                            <div id="listAmbil<?php echo $ctr;?>" class="collapse " data-bs-parent="#accordion-2">
                                <div class="row mt-2 mb-n2" style="justify-content: center;">
                                    <div class="col-5 pe-1">
                                        <a href="<?php echo base_url() . "dokum_dl/download_agen?idr=" . $ambil[0]->idSecretRequest. "&idm=" . $id_secret; ?>"
                                            class="btn btn-m btn-full mb-3 rounded-xs text-uppercase font-500 shadow-s bg-highlight">Download
                                            Imigrasi</a>
                                    </div>
                                    <div class="col-5 pe-1 ps-1">
                                        <a href="<?php echo base_url() . "dokum_dl/kemenag_agen?idr=" . $ambil[0]->idSecretRequest. "&idm=" . $id_secret; ?>"
                                ...
                                <div class="row" style="justify-content: center;">
                                    <div class="col-8 pe-1 ps-1">
                                        <a href="<?php echo base_url() . "konsultan/request_dokumen_konsultan/hapus?idr=" . $ambil[0]->idSecretRequest . "&idm=" . $id_secret; ?>"
