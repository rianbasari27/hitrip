...
<body class="theme-light">
        ...
        <div class="page-content">
            ...
            <div class="card card-style">
                <div class="content mt-0 mb-0">
                    <form role="form"
                        action="<?php echo base_url(); ?>konsultan/request_dokumen_konsultan/proses_input_req"
                        ...
                        <div class="form-group mt-4">
                            ...
                            <div class="input-style no-borders has-icon  mb-4">
                                <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap"
                                    ...
                                    required>
                                <i
                                    class="fa fa-check <?php echo $jamaah->first_name == NULL ? 'disabled ' : ''; ?>valid color-green-dark"></i>
                                <em></em>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3 mt-2">
                            ...
                            <div class="input-style no-borders has-icon  mb-4">
                                ...
                                <i
                                    class="fa fa-check <?php echo $member[0]->paket_info->nama_paket == NULL ? 'disabled ' : ''; ?>valid color-green-dark"></i>
                                <em></em>
                            </div>
                        </div>
                        <div class="form-group mb-3 mt-2">
                        ...
                        <div class="form-group mb-3 mt-2">
                            ...
                            <!-- <span>Catatan : Datang ke kantor jika wajib tanda tangan basah</span> -->
                        </div>
                        <div class="form-group mb-3 mt-2">
                        ...
                        <button class="btn btn-l font-600 font-13 gradient-highlight rounded-s mb-3">Submit</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        // $("#kantorImigrasi").on('input', function(){
        //         var x = $(this).val();
        //         console.log(x);
        //     });
        
        // var x = $("#kantorImigrasi").val();
        // console.log(x);
        // set tanggal
        ...
        $("#kantorImigrasi").autocomplete({
            source: "<?php echo base_url() . 'konsultan/request_dokumen_konsultan/getImigrasi'; ?>",
            change: function(event, ui) {
                var kantor = $(this).val();
                $.getJSON("<?php echo base_url() . 'konsultan/request_dokumen_konsultan/getImigrasiId';?>", {
                    namaKantor: kantor,
                }).done(function(json) {
