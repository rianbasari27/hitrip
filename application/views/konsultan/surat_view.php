    ...
    <div id="page">
        ...
        <div class="card card-style bg-11 mt-3" data-card-height="250">
                <div class="card-top ps-3 mt-3 mb-2">
                    <a href="<?php echo base_url() . 'konsultan/surat_doa/' ?>" class="py-2 px-3 bg-white rounded-l color-dark-dark"><i class="fa-solid fa-arrow-left me-2"></i>Semua surat</a>
                </div>
                    ...
                    <?php foreach ( $ayat as $a) { ?>
                        <div class="align-self-center mt-3" id="ayat<?php echo $a['nomorAyat'] ?>">
                            <div class="d-flex mb-3">
                                ...
                                <a href="#" data-id="<?php echo $a['nomorAyat'] ?>" id="a<?php echo $a['nomorAyat']?>" class="btnTandai btn btn-xs ms-2 py-1 px-3 btn-border border-highlight color-highlight opacity-80 rounded-l my-auto">
                                    <i class="fa-solid fa-bookmark me-2"></i>Tandai
                                </a>
                            </div>
                            <span class="d-block text-end font-28 color-dark-dark mb-0 lh-base"><?php echo $a['teksArab'] ?></span>
                        </div>
    ...
    $(document).ready(function() {
        ...
        function setBookmark() {
            ...
            token.then((result) => {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url() . 'konsultan/surat_doa/get_bookmark'?>', 
                    data: { 
                        userId: result,
                    },
        ...
        $('.btnTandai').on('click', function (e) {
            ...
            token.then((result) => {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url() . 'konsultan/surat_doa/tandai_ayat'?>', 
                    data: { 
                        userId: result,
                        nomorAyat: nomorAyat,
