...
<body class="theme-light">
    ...
    <div id="page">
        ...
        <div class="page-content">
            <div class="card card-style bg-red-dark" data-card-height="170">
                <div class="content">
                    <div class="d-flex mb-3">
                        <h4><i class="fa fa-3x fa-exclamation-circle color-white scale-box shadow-xl rounded-circle"></i></h4>
                        <h3 class="my-auto ms-3 color-white">Lengkapi Data Jamaah Anda</h3>
                    </div>
                    <span class="color-white font-16">Lengkapi data jamaah Anda untuk keperluan <strong>Dokumen</strong> dan <strong>Perlengkapan</strong>.</span>
                </div>
            </div>
            ...
            <div class="card card-style">
                <div class="content">
                    ...
                    <form  action="<?php echo base_url(); ?>konsultan/jamaah_info/proses_lengkapi_data" method="post" id="myForm">
                        <div class="mt-4 mb-">
    ...
    <div id="datepicker"  
        ...
        <div class="content mt-0">
            ...
            <form name="date">
                ...
                <button type="button" id="setTanggal" class="close-menu btn btn-set-tanggal btn-full gradient-highlight font-13 btn-sm font-600 rounded-s">Pilih</button>
            </form>
            </div>
        </div>
    </div>   
