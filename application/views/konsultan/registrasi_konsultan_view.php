...
<body class="theme-light">
    ...
    <div id="page">
        ...
        <div class="page-content header-clear-medium">
            <form action="<?php echo base_url(); ?>konsultan/daftar_konsultan/proses_tambah" method="post" id="myForm"
                        ...
                        <div class="mt-1 mb-3">
                                ...
                                <div
                                    ...
                                    <select name="id_agen_paket" class="form-control" id="slct">
                                        <option class="color-dark-dark"
                                            value="<?php echo isset($_SESSION['form']['id_agen_paket']) ? $_SESSION['form']['id_agen_paket'] : ''; ?>"
                            ...
                            <div class="mb-4 card card-style mx-0 d-none" id="detailProg">
                                <div class="content mb-0">
                                    <div id="appendFlyer" class="mb-2"></div>
                                    ...
                                    <span id="tanggalProg"></span><br>
                                    <div id="appendDesc"></div><br>
                                </div>
                            </div>
                            <div class="form-group">
                                <!-- <label class="text-success ms-3 mb-3">Nama yang merekomendasikan</label> -->
                                <div
                                    class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                                    <input type="hidden" id="id_upline" name="upline_id" value="">
                                    <input type="text" class="form-control validate-name" id="inputAgen" placeholder=""
                                        value="<?php echo isset($_SESSION['form']['nama_upline']) ? $_SESSION['form']['nama_upline'] : ''; ?>">
                                    <label for="inputAgen" class="color-highlight">Nama Upline <strong
                                            class="text-danger">
                                            *</strong></label>
                                    <em></em>
                                </div>
                            ...
                            <div class="form-group">
                                <div
                                    class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                                    <input name="nama_agen" type="name" class="form-control validate-name upper"
                                        id="form1" placeholder=""
                                        value="<?php echo isset($_SESSION['form']['nama_agen']) ? $_SESSION['form']['nama_agen'] : ''; ?>">
                                ...
                                <div
                                    ...
                                    <a href="#" data-menu="datepicker2" class="text-dark">
                                        <input name="tanggal_lahir" type="date" class="form-control validate-name upper"
                                            id="form2" readonly
                                            value="<?php echo isset($_SESSION['form']['tanggal_lahir']) ? $_SESSION['form']['tanggal_lahir'] : ''; ?>">
                                        <label for="form2" class="color-highlight">Tanggal Lahir <strong
                            ...
                            <div class="form-group">
                                <div
                                    class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                                    <input name="email" type="text" class="form-control validate-name upper" id="form3"
                                        placeholder=""
                            ...
                            <div class="form-group">
                                <div
                                    class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                                    <input name="no_wa" type="number" class="form-control validate-name upper"
                                        id="form4" placeholder=""
                                        value="<?php echo isset($_SESSION['form']['no_wa']) ? $_SESSION['form']['no_wa'] : ''; ?>">
                            ...
                            <div class="form-group">
                                <div
                                    class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                                    <textarea name="alamat" type="number" class="form-control validate-name upper"
                                        id="form5" placeholder=""
                                        value="<?php echo isset($_SESSION['form']['alamat']) ? $_SESSION['form']['alamat'] : ''; ?>"></textarea>
                                    <label for="form5" class="color-highlight">Alamat Lengkap <strong
                                            class="text-danger">
                                            *</strong></label>
                                    <i class="fa fa-times disabled invalid color-red-dark"></i>
                                    <i class="fa fa-check disabled valid color-green-dark"></i>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo base_url() . 'asset/images/ukuran_baju.jpeg' ?>" title="Size Chart"
                                    class="d-flex justify-content-center my-3" data-gallery="gallery-1">
                                    <img src="<?php echo base_url() . 'asset/images/ukuran_baju.jpeg' ?>" width="50%"
                                        class="rounded-sm shadow-m img-fluid">
                                </a>
                                <div
                                    class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                                    <select name="ukuran_baju" class="form-control" id="slct">
                                        <option class="color-dark-dark"
                                            value="<?php echo isset($_SESSION['form']['ukuran_baju']) ? $_SESSION['form']['ukuran_baju'] : ''; ?>"
                                            disabled selected>Pilih salah satu ... </option>
                                        <option value="XXL"
                                            <?php echo (isset($_SESSION['form']['ukuran_baju']) && $_SESSION['form']['ukuran_baju']) == 'XXL' ? 'checked' : ''; ?>>
                                            XXL</option>
                                        <option value="XL"
                                            <?php echo (isset($_SESSION['form']['ukuran_baju']) && $_SESSION['form']['ukuran_baju']) == 'XL' ? 'checked' : ''; ?>>
                                            XL</option>
                                        <option value="L"
                                            <?php echo (isset($_SESSION['form']['ukuran_baju']) && $_SESSION['form']['ukuran_baju']) == 'L' ? 'checked' : ''; ?>>
                                            L</option>
                                        <option value="M"
                                            <?php echo (isset($_SESSION['form']['ukuran_baju']) && $_SESSION['form']['ukuran_baju']) == 'M' ? 'checked' : ''; ?>>
                                            M</option>
                                        <option value="S"
                                            <?php echo (isset($_SESSION['form']['ukuran_baju']) && $_SESSION['form']['ukuran_baju']) == 'S' ? 'checked' : ''; ?>>
                                            S</option>
                                    </select>
                                    <i class="fa fa-times disabled invalid color-red-dark"></i>
                                    <i class="fa fa-check disabled valid color-green-dark"></i>
                            ...
                            <div class="form-group">
                                <label class="color-highlight ms-3">Foto Diri ( <span class="text-primary"> Upload 2
                                        foto</span> )<strong class="text-danger">
                                        *</strong></label><br>

                                <!-- <img src="<?php echo base_url() . 'asset/images/ukuran_baju.jpeg' ?>" class=""> -->
                                <!-- <div class="row"> -->
                                <a href="<?php echo base_url() . 'asset/images/foto_diri.jpeg' ?>" title="Foto Diri"
                                    class="d-flex justify-content-center my-3" data-gallery="gallery-1">
                                    <img src="<?php echo base_url() . 'asset/images/foto_diri.jpeg' ?>" width="50%"
                                        class="rounded-sm shadow-m img-fluid">
                                </a>
                                <!-- </div> -->
                                <div class="card card-style mx-0 shadow-none p-2">
                                    <input class="form-control border-none rounded-xs mb-3" type="file"
                                        name="foto_diri">
                            ...
                            <div class="form-group">
                                <div
                                    class="input-style has-borders no-icon input-style-always-active validate-field mb-4">
                                    <input name="no_ktp" type="number" class="form-control validate-name upper"
                                        id="form6" placeholder=""
                                        value="<?php echo isset($_SESSION['form']['no_ktp']) ? $_SESSION['form']['no_ktp'] : ''; ?>">
                            ...
                            <div class="form-group">
                                <div class="input-style has-borders input-style-always-active validate-field mb-4">
                                    <label for="select" class="color-highlight">Jenis Kelamin <strong
                                            class="text-danger">
                                            *</strong></label>
                                    <select name="jenis_kelamin" id="form-9">
                                        ...
                                        <option class="color-dark-dark" value="L"
                                            <?php echo (isset($_SESSION['form']['jenis_kelamin']) && $_SESSION['form']['jenis_kelamin']) == 'L' ? 'checked' : ''; ?>>
                                            LAKI-LAKI</option>
                                        <option class="color-dark-dark" value="P"
                                            <?php echo (isset($_SESSION['form']['jenis_kelamin']) && $_SESSION['form']['jenis_kelamin']) == 'P' ? 'checked' : ''; ?>>
                                            PEREMPUAN</option>
                                    </select>
        ...
        <div id="menu-main" class="menu menu-box-left rounded-0"
            data-menu-load="<?php echo base_url() . 'jamaah/home/main_menu'; ?>" data-menu-width="280"
            data-menu-active="nav-welcome"></div>

        <!-- Share Menu-->
        <div id="menu-share" class="menu menu-box-bottom rounded-m"
            data-menu-load="<?php echo base_url() . 'jamaah/home/share'; ?>" data-menu-height="370"></div>

        <!-- Colors Menu-->
        <div id="menu-colors" class="menu menu-box-bottom rounded-m"
            data-menu-load="<?php echo base_url() . 'jamaah/home/colors'; ?>" data-menu-height="480"></div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $('#slct').change(function() {
            ...
            var paket = [];
            $.getJSON("<?php echo base_url() . 'konsultan/daftar_konsultan/get_paket' ?>", {
                    term: selected,
                })
                .done(function(data) {
                    ...
                    if (diskon == 0) {
                        ...
                        $('#appendHarga').append(
                            '<del style="color:red;text-decoration:line-through" id="diskon"><span class="mt-1 mb-0" id="harga"></span></del>'
                        )
                        document.getElementById('harga').innerText = harga;
                        document.getElementById('hargaDiskon').innerText = hargaDiskon;
                    }

                    // document.getElementById('sisaPax').innerText = 'Sisa Pax : ' + pax;
                    document.getElementById('tanggalProg').innerText = 'Tanggal : ' + tanggal;

                    if (exJamaah != 0) {
                        $('#desc').remove();
                        $('#appendDesc').append('<span id="desc">' + descExJamaah + ' ' +
                            discExJamaah + '</span>')
                    } else {
                        $('#desc').remove();
                    }
