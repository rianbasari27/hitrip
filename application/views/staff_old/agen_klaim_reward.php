                                ...
                                <div class="col-lg-12">
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-primary">Tukar Poin dengan Reward</h6>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?php echo base_url(); ?>staff/kelola_agen/proses_klaim" method="post">
                                                <input type="hidden" name="id_agen" value="<?php echo $id_agen; ?>">
                                                <div class="form-group">
                                                    <label class="col-form-label">Poin yang Dapat Ditukarkan : </label>
                                                    <span style="color: #4ec738;" class="font-weight-bold"><?php echo $unclaimed_point; ?> poin</span>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-form-label">Jumlah Poin yang Akan Ditukarkan</label>
                                                    <input class="form-control" type="number" name="point">
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-form-label">Keterangan Reward</label>
