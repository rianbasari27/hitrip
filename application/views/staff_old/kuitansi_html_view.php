        ...
        <table cellspacing="0">
            ...
            <tr>
                <td style="text-align: left;">
                    <?php echo implode(" ", [$dm['detailJamaah']->first_name, $dm['detailJamaah']->second_name, $dm['detailJamaah']->last_name]); ?><?php echo ($dm['detailJamaah']->member[0]->kategori != '' || $dm['detailJamaah']->member[0]->kategori != null) ? " ( " . $dm['detailJamaah']->member[0]->kategori . " ) " : '' ;?>
                </td>
                <td>:</td>
            ...
            <?php foreach ($dm['biayaExtra'] as $ef) { 
                    ...
                    ?>
            <tr>
                <td><?php echo $ef->keterangan . (count($riwayat['tarif']['dataMember']) > 1 ? ' <strong>(' . $dm['detailJamaah']->first_name . ')</strong>' : ''); ?>
                </td>
                <td>:</td>
            ...
            <tr>
                <td><?php echo $dm['deskripsiExtraFeeProgram'] . (count($riwayat['tarif']['dataMember']) > 1 ? ' <strong>(' . $dm['detailJamaah']->first_name . ')</strong>' : ''); ?>
                </td>
                <td>:</td>
