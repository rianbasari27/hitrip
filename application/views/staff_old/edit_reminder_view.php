                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4 border-left-primary">
                                    ...
                                    <div class="card-body">
                                        <form role="form" action="<?php echo base_url(); ?>staff/reminder/proses_edit"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $kode_bayar ;?>" name="kode_bayar"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control format_harga" value="<?php echo $nominal ;?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control" id="slct"
                                                    ...
                                                    <option value="bulan"
                                                        <?php echo $status == 'bulan' ? 'selected' : '' ;?>>Reminder per
                                                        bulan</option>
                                                    <option value="tahun"
                                                        <?php echo $status == 'tahun' ? 'selected' : '' ;?>>Reminder per
                                                        tahun</option>
                                                </select>
                                            </div>
                                            <div class="form-group" id="Bulan"
                                                style="<?php echo $status == 'bulan' ? 'display: block;' :'display: none;' ;?>">
                                                ...
                                                <input type="text" name="tgl_bulan" class="form-control"
                                                    ...
                                                    value='<?php echo $status == 'bulan' ? "$tgl_reminder" : "" ?>'>
                                            </div>
                                            <div class="form-group" id="Tahun"
                                                style="<?php echo $status == 'tahun' ? 'display: block;' :'display: none;' ;?>">
                                                <label class="col-form-label">Tanggal Pembayaran (<span
                                                        class="text-primary font-italic font-weight-lighter"> Jadwal
                                                ...
                                                <input type="text" name="tgl_tahun" class="form-control"
                                                    ...
                                                    value='<?php echo $status == 'tahun' ? "$tgl_reminder" : "" ?>'>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="jadwal"
                                                    placeholder="Contoh : 10,15,20" value="<?php echo $jadwal ;?>">
                                            </div>
                                            <div class="form-group">
