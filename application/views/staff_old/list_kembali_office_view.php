                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">List Pengembalian Barang Office</h1>
                        </div>
                                ...
                                <div class="card shadow mb-4 border-left-primary">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">
                                            <strong>List barang yang dikembalikan</strong>
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
    ...
    $(document).ready(function() {
        ...
        function loadDatatables() {
            ...
            var dataTable = $('#dataTable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo base_url(); ?>staff/perlengkapan_office/load_kembali",
                    "data": {
                ...
                columns: [{
                    ...
                    //             orderButton =
                    //                 '<a href="javascript:void(0);" class="btn btn-primary btn-sm order_btn mt-1">Order</a>';
                    //         }
                    //         return orderButton
                    //         // '\n\
