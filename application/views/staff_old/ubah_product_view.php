                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4 border-left-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php } ?>
                                        <form role="form"
                                            action="<?php echo base_url(); ?>staff/online_store/proses_ubah"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" class="form-control">
                                                    ...
                                                    <?php foreach ($category as $c) { ?>
                                                        <option value="<?php echo $c->category_id ;?>" <?php echo $product->category_id == $c->category_id ? 'selected' : '' ;?>><?php echo $c->category_name ;?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control format_harga" type="text"
                                                    ...
                                                    value="<?php echo number_format($product->discount_amount) ?>">
                                            </div>
