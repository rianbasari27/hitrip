                            ...
                            <div class="col-lg-12">
                                <div class="card shadow mb-4 border-left-danger">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Siap Untuk Diambil</h6>
                                    </div>
                                    <div class="card-body">
                                        <?php if (empty($pendingBooking['items'])) { ?>
                                        <div>
                                            Tidak ada perlengkapan yang siap diambil
                                        </div>
                                        <?php } ?>
                                        <?php $ctr = 0; ?>
                                        ...
                                        <div class="card shadow mb-4 border-left-danger">
                                            <a href="#pendingBooking<?php echo $ctr; ?>"
                                                ...
                                                <h6 class="m-0 font-weight-bold text-primary"><span>Pengiriman Tanggal :
                                            ...
                                            <div class="collapse show" id="pendingBooking<?php echo $ctr; ?>">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <form
                                                            action="<?php echo base_url() . 'staff/perlengkapan_peserta/status_ambil'; ?>"
                                                            method="post">
                                                            <input type="hidden" name="jenis_ambil"
                                                                value="<?php echo $jenisAmbil ;?>">
                                                            <input type="hidden" name="idm"
                                                                value="<?php echo $member->id_member; ?>">
                                                            <input type="hidden" name="noWa"
                                                                value="<?php echo $noKirim; ?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-form-label">Input Nama
                                                                    Penerima</label>
