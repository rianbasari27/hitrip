                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4 border-left-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php } ?>
                                        <form role="form" action="<?php echo base_url(); ?>staff/agen_paket/proses_ubah"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="is_member" id="" class="form-control">
                                                    <option value="2" <?php echo ( $is_member == 2 || $is_member == null ) ? 'checked':'';?>>Konsultan Lama & Konsultan Baru</option>
                                                    <option value="1" <?php echo $is_member == 1 ? 'checked':'';?>>Konsultan Lama</option>
                                                    <option value="0" <?php echo $is_member == 0 ? 'checked':'';?>>Konsultan Baru</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="active" value="1"
                                                            <?php echo $active == 1 ? 'checked' :'' ;?>> Publish
                                                    </label>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group">
